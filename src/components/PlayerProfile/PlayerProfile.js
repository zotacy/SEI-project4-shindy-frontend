            ...
            <main className="profile">
              <div className="playerInfo">
                ...
                <form onSubmit={this.props.updateProfile}>
                    ...
                    Name:<input id='name' type="text" name="name" placeholder={playerDetails.name} /><br/>
                    Email:<input id='email' type="text" name="email" placeholder={playerDetails.email} /><br/>
                    Username:<input id='username' type="text" name="username" placeholder={playerDetails.username} /><br/>
